...
int main()
{
	...
	if(menu==1)
	{
		if(j_MP4A1>0) printf("Stock MP4A1 : %d\n", j_MP4A1);
		if(j_PM2_V1>0) printf("Stock PM2-V1 : %d\n", j_PM2_V1);
		if(j_SPR_3>0) printf("Stock SPR-3 : %d\n", j_SPR_3);
		if(j_SS2_V5>0) printf("Stock SS2-V5 : %d\n", j_SS2_V5);
		if(j_SPG1_V3>0) printf("Stock SPG1-V3 : %d\n", j_SPG1_V3);
		if(j_MINE>0) printf("Stock MINE : %d\n", j_MINE);
	}
	else if(menu==2)
	{
